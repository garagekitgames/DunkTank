...
{
    /// <summary>
    /// Abstract base class for Actions referencing a Spawner
    /// </summary>
    [System.Serializable]
    public abstract class GameActionSpawnerBase : GameAction
    {
        /// <summary>
        /// The Spawner to start
        /// </summary>
        public ProPooling.Components.Spawner Spawner
        {
            get
            {
                return _spawner;
        ...
        [Tooltip("The Spawner to start")]
        [SerializeField]
        ProPooling.Components.Spawner _spawner;
...
#region IScriptableObjectContainerSyncReferences
        ...
        public override void SetReferencesFromContainer(UnityEngine.Object[] objectReferences)
        {
            if (objectReferences != null && objectReferences.Length == 1)
                Spawner = objectReferences[0] as ProPooling.Components.Spawner;
        }
