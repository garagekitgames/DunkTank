...
namespace ProPooling.Components
{
    ...
    /// </summary>
    [AddComponentMenu("Pro Pooling/On Despawn Reset Rigidbody2D", 6)]
    [HelpURL("http://www.flipwebapps.com/pro-pooling/")]
    [RequireComponent(typeof(Rigidbody2D))]
    public class OnDespawnResetRigidbody2D : MonoBehaviour, IPoolComponent
    {
        ...
        /// <summary>
        /// Reset physics details when despawned back to a pool
        /// </summary>
