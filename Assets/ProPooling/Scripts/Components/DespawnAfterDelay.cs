...
namespace ProPooling.Components
{
    ...
    /// </summary>
    [AddComponentMenu("Pro Pooling/Despawn After Delay", 4)]
    [HelpURL("http://www.flipwebapps.com/pro-pooling/")]
    public class DespawnAfterDelay : MonoBehaviour, IPoolComponent
    {
        /// <summary>
        ...
        {
            StartCoroutine(DespawnDelayayed(poolItem));
        }
        ...
        IEnumerator DespawnDelayayed(PoolItem poolItem)
        {
