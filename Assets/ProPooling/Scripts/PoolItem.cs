...
namespace ProPooling
{
    ...
    /// 
    /// You can override this class and use it to store and parse per pooled item information for your own purposed.
    /// Be sure to consider whether to call the base class methods if you are overriding anything. 
    /// See PoolGeneric for information about using subclassed versions of this class.
    [Serializable]
