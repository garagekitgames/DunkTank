...
namespace ProPooling._Demo
{
    ...
    public class CustomPoolItemMetaData : MonoBehaviour
    {
        ...
        void Start()
        {
            // We need to setup such an item manually or through the editor (GlobalPools only works with standard PoolItem types).
            ...
            pool.Despawn(poolItem);

            poolItem = pool.SpawnPoolItem();
