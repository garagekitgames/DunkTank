...
public class RagdollDriver : MonoBehaviour {
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// Master and Slave transforms
	/// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


	public GameObject master;
	public bool EnableJointLimit = true;
	...
	public float fixedDeltaTime = 0.008f; // If you choose to go to longer times you need to lower PTorque, PLocalTorque and PForce or the system gets unstable. Can be done, longer time is better performance but worse mimicking of master.
	...
	[Range(0f, 100f)] public float topMaxForce = 100f;
	[Range(0f, 10000f)] public float maxJointTorque = 10000f; // Limits the force --> Spring Strength on joints
	[Range(0f, 10000f)] public float topMaxJointTorque = 10000f; // Limits the force --> Spring Strength on joints
	[Range(0f, 10f)] public float jointDamping = .6f; // Limits the force

	public float[] maxTorqueProfile = {100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f }; // Individual limits per limb
	public float[] maxForceProfile = {1f, .2f, .2f, .2f, .2f, 1f, 1f, .2f, .2f, .2f, .2f, .2f, .2f, .2f, .2f };
	public float[] maxJointTorqueProfile = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f };
	public float[] jointDampingProfile = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f };
	...
	public float[] PTorqueProfile = {20f, 30f, 10f, 30f, 10f, 30f, 30f, 30f, 30f, 10f, 30f, 10f, 10f, 30f, 10f }; // Per limb world space torque strength for EthanRagdoll_12 (twelve rigidbodies)
	public float[] PForceProfile = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f };

	// The ranges are not set in stone. Feel free to extend the ranges
	[Range(0f, 340f)] public float angularDrag = 100f; // Rigidbodies angular drag. Unitys parameter //default 100
	...
	//PD control using torque, works for bool torque = true;
	...
	//PD control using force, works for bool force = true;
	//Vector3 forceAxis;
	Vector3 forceSignal;
	Vector3 forceError;
	...
	public float[] forceErrorWeightProfile = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f }; // Per limb error weight
	...
	void Awake() // Initialize
	{
		...
		///////////////////////////////////////////////////////////////Error Handle if master is absent
		if (!master)
		{
			UnityEngine.Debug.LogWarning("Master not assigned in RagdollDriver script on " + this.name + "\n");
			userNeedsToAssignStuff = true;
			return;
		}

		/////////////////////////////////////////////////////////////Hide The master meshes
		/*else if (hideMaster)
		{
		...
		//////////////////////////////////////////////////////Setup Slave and Master transforms
		...
		/////////////////////////////////////////////////////Error if master transforms are not equal to slave transforms 
		...
		//////////////////////////////////////////////////// Setting up arrays to store things needed for slave positioning
	...
	public void DoAnimFollow()
	{
		...
		for (int i = 0; i < slaveRigidTransforms.Length; i++) // Do for all rigid bodies
		{
			...
			if (i > 0 && (maxJointTorqueProfile[i] >0))
	...
	public void HandleImpact (float positionSpring, float positionDamper)
	{
		for (int i = 1; i < configurableJoints.Length; i++) // Do for all configurable joints
		{
			jointDrive.positionSpring = positionSpring * maxJointTorqueProfile[i];
