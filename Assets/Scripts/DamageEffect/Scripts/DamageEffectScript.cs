...
namespace DamageEffect
{
    ...
    public class DamageEffectScript : MonoBehaviour
    {
        ...
        private Dictionary<MeshRenderer, Material> _damageMaterials;
        public MeshRenderer[] _rendereres;
        public List<MeshRenderer> _listRendereres;
        public MeshRenderer[] _tempRendereres;

        private static Dictionary<Texture, Material> _damageMaterialsCache = new Dictionary<Texture, Material>();

        private void Start()
        {
            _listRendereres = new List<MeshRenderer>();
            _tempRendereres = GetComponentsInChildren<MeshRenderer>();
            ...
            _damageMaterials = new Dictionary<MeshRenderer, Material>();
